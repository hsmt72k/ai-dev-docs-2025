---
title: 09. Chat Component
description: チャットコンポーネント
icon: Rocket
---
...
![](/hands-on/01-basic-rag-app/09_chat_component/chat_component.png)

チャットができるか、動作確認をしてみる。

<img
  src="/hands-on/01-basic-rag-app/09_chat_component/first_e2e_test.webp"
  alt=""
/>
