---
title: 15. Ex.03 Chat With Personality
description: エクササイズ.03 個性を持ったチャット
icon: Rocket
---
...
```diff title="src/app/api/chat-with-personality/route.ts"
...
<img
  src="/hands-on/01-basic-rag-app/15_ex03_chat_with_personality/test_chat_with_personality_route_api.webp"
  alt=""
/>
