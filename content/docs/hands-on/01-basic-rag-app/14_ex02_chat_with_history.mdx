---
title: 14. Ex.02 Chat With History
description: エクササイズ.02 履歴付属チャット
icon: Rocket
---
...
```diff title="src/app/api/chat-with-history/route.ts"
...
<img
  src="/hands-on/01-basic-rag-app/14_ex02_chat_with_history/test_chat_with_history_route_api.webp"
  alt=""
/>
