---
title: 01. Setup Next.js Project
description: Next.js プロジェクトのセットアップ
icon: Rocket
---
...
![](/hands-on/01-basic-rag-app/04_setup_nextjs_project/window_of_system_env_variable_editor.png)

![](/hands-on/01-basic-rag-app/04_setup_nextjs_project/path_to_bun_exe_and_bunx_exe.png)

`bun.exe` と `bunx.exe` が格納されている場所へのパスが通っていることで `bun` コマンドや `bunx` コマンドが実行できるようになる。

![](/hands-on/01-basic-rag-app/04_setup_nextjs_project/bun_exe_and_bunx_exe.png)
...
![](/hands-on/01-basic-rag-app/04_setup_nextjs_project/bun_lockb.png)
...
![](/hands-on/01-basic-rag-app/04_setup_nextjs_project/bun_run_dev_in_terminal.png)
...
![](/hands-on/01-basic-rag-app/04_setup_nextjs_project/dev_script_in_package_json.png)
...
![](/hands-on/01-basic-rag-app/04_setup_nextjs_project/home_page.png)
...
![](/hands-on/01-basic-rag-app/04_setup_nextjs_project/open_json_file_in_windows_terminal.png)
...
![](/hands-on/01-basic-rag-app/04_setup_nextjs_project/bash_profile.png)
...
![](/hands-on/02-movie-recommendations-app/01_setup_nextjs_project/rewrite_home_page.png)
...
![](/hands-on/02-movie-recommendations-app/01_setup_nextjs_project/change_font_to_noto_sans_jp.png)

Tailwind CSS を使うために VSCode の拡張機能で Tailwind CSS IntelliSense をインストールする。

![](/hands-on/01-basic-rag-app/04_setup_nextjs_project/install_extension_of_tailwind_css_intellisense.png)

Tailwind CSS IntelliSense をインストールすることで、Ctrl + Space キーを押した時に、Tailwind CSS のクラス名を補完してくれるようになる。

<img
  src="/hands-on/01-basic-rag-app/04_setup_nextjs_project/tailwind_css_intellisense_in_vscode.webp"
  alt=""
/>
...
![](/hands-on/02-movie-recommendations-app/01_setup_nextjs_project/font_extrabole_with_tailwind_css.png)

GitHub リポジトリを作成する。

![](/hands-on/02-movie-recommendations-app/01_setup_nextjs_project/create_new_github_repository.png)

![](/hands-on/02-movie-recommendations-app/01_setup_nextjs_project/created_new_github_repository.png)
...
![](/hands-on/02-movie-recommendations-app/01_setup_nextjs_project/push_to_github_repository.png)
