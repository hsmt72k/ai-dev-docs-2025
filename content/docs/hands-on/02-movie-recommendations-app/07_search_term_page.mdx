...
<img
  src="/hands-on/02-movie-recommendations-app/07_search_term_page/search_but_not_found_page.webp"
  alt=""
/>
...
![](/hands-on/02-movie-recommendations-app/07_search_term_page/search_term_with_in.png)

「アクション」で検索してみる。４件ヒットした。

![](/hands-on/02-movie-recommendations-app/07_search_term_page/search_term_with_action.png)

「サイエンス」で検索してみる。５件ヒットした。

![](/hands-on/02-movie-recommendations-app/07_search_term_page/search_term_with_science.png)

「あ」で検索してみる。

![](/hands-on/02-movie-recommendations-app/07_search_term_page/search_term_with_japanese_a.png)
