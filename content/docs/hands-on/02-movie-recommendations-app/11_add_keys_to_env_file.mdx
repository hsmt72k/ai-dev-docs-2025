---
title: 11. Add Keys to .env File
description: .env ファイルへの環境変数の追加
icon: Rocket
---
...
![](/hands-on/02-movie-recommendations-app/11_add_keys_to_env_file/data_stax_click_target_database_in_databases_page.png)
...
![](/hands-on/02-movie-recommendations-app/11_add_keys_to_env_file/data_stax_click_connection_details_button_in_target_database_page.png)

「Generated token」ボタンをクリックします。

![](/hands-on/02-movie-recommendations-app/11_add_keys_to_env_file/data_stax_submit_generate_token_button_in_connection_details_modal.png)
...
![](/hands-on/02-movie-recommendations-app/11_add_keys_to_env_file/data_stax_copy_api_key_in_conection_details_modal.png)
...
![](/hands-on/02-movie-recommendations-app/11_add_keys_to_env_file/data_stax_connection_details_modal.png)
...
![](/hands-on/02-movie-recommendations-app/11_add_keys_to_env_file/data_stax_copy_db_endpoint_url.png)
