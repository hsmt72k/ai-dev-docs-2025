---
title: 04. Next.js プロジェクトのセットアップ
...
export default function Home() {
  return (
    <div className="h-screen flex justify-center items-center">
      <h1>RAG を使った AI チャットアプリ</h1>
    </div>
  )
}
```

![](/02-hands-on/01-basic-rag-app/04_setup_nextjs_project/rewrite_home_page.png)
...
![](/02-hands-on/01-basic-rag-app/04_setup_nextjs_project/change_font_to_noto_sans_jp.png)
...
![](/02-hands-on/01-basic-rag-app/04_setup_nextjs_project/font_extrabole_with_tailwind_css.png)

GitHub リポジトリを作成する。

![](/02-hands-on/01-basic-rag-app/04_setup_nextjs_project/create_new_github_repository.png)

![](/02-hands-on/01-basic-rag-app/04_setup_nextjs_project/created_new_github_repository.png)
...
git commit -m '04. Setup Next.js Project'
git branch -M main
...
![](/02-hands-on/01-basic-rag-app/04_setup_nextjs_project/push_to_github_repository.png)
