...
![](/02-hands-on/02-movie-recommendations-app/02_setup_shadcn_ui/add_plain_button.png)
...
![](/02-hands-on/02-movie-recommendations-app/02_setup_shadcn_ui/flexbox_to_h1_and_button.png)
...
![](/02-hands-on/02-movie-recommendations-app/02_setup_shadcn_ui/change_button_variant_to_destructive.png)
...
![](/02-hands-on/02-movie-recommendations-app/02_setup_shadcn_ui/add_size_xl_to_button_component.png)
...
![](/02-hands-on/02-movie-recommendations-app/02_setup_shadcn_ui/adjust_styles_to_button.png)

コミットを行う。

```bash title="Terminal"
git add .
git commit -m '02. Setup shadcn/ui'
git push
```
